...
class Quality:
    ...
    def nameQuality(name):
        ...
        elif checkName(["720p", "hdtv", "x264"], all) or checkName (["720p", "hdtv"], any) or checkName(["hr.ws.pdtv.x264"], any) and not checkName(["xvid", "divx"], any):
            return Quality.HDTV
        elif checkName(["720p", "web.dl"], all) or checkName(["720p", "itunes", "h.?264"], all) or checkName (["720p", "web-dl"], all) and not checkName(["xvid", "divx"], any):
